...
public class CraftBet_901_LifeGamesTimeOut_Test extends BaseTest{


    public CraftBet_901_LifeGamesTimeOut_Test() throws AWTException {
    }
...
//            System.out.println(allMinutes + "  " + day + "  " + hour + "   " + minutes);
        ...
        if (errorSrcXl.size() == 0) {
            ...
            basePage.writeInExel(errorSrcXl, "/src/test/java/CraftBet_002_TimeOutGames/" + readConfig.partnerConfigNum() + partnerName + "DataTimeOutGamesList.xlsx", "TimeOutGames");
            isPassed = false;
        }
        return isPassed;
    }
